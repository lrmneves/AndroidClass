...
public class AtomPayListAdapter extends ArrayAdapter<Presentation> {
	...
	public AtomPayListAdapter(Context context, int layoutResourceId, List<Presentation> items) {
